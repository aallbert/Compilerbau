...
{
       0,    27,    27,    34,    38,    45,    49,    53,    60,    64,
      71,    78,    82,    86,    90,    94,    98,   102
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DECLARE", "PREDICATE", "FUNCTION", "VARIABLE", "EXIST", "ALL", "LBRACK",
  "RBRACK", "LPAREN", "RPAREN", "AND", "COMMA", "SEMICOLON", "COLON", "OR",
  "NEGATION", "$accept", "program", "declarations", "declaration",
...
{
      -1,    15,     5,    -3,   -12,    16,    21,    22,   -12,    13,
       7,    17,     0,   -12,     0,   -12,    -4,     9,    11,    12,
      28,    29,    30,    -7,   -12,     0,   -12,     0,    31,    32,
      34,    18,    26,    27,    -7,    -7,   -12,   -12,   -12,    37,
      33,    35,    36,    38,    39,   -12,    40,    41,    42,    44,
      45,    46,   -12,   -12
};
...
{
       0,     0,     0,     0,     3,     0,     0,     0,     1,    17,
       0,     0,     0,     4,     2,     8,     0,     0,     0,     0,
       0,     0,     0,    15,     9,     0,    10,     0,     0,     0,
       0,     0,     0,     0,    13,    14,     5,     6,     7,     0,
...
{
       9,    23,     1,     9,     1,     8,    10,    11,    25,    10,
      11,    25,    27,    26,    34,    27,    35,    12,    21,    17,
      12,     5,     6,     7,    18,    19,    20,    28,    22,    29,
      30,    31,    32,    33,    39,    36,    37,    38,    40,    41,
      42,    46,    47,     0,     0,    50,    43,    51,    44,     0,
      45,    13,     0,     0,     0,     0,    48,    49,     0,    52,
      53,    24
};

static const yytype_int8 yycheck[] =
{
       3,    12,     5,     3,     5,     0,     9,    10,    15,     9,
      10,    15,    19,    17,    25,    19,    27,    20,    11,     3,
      20,     6,     7,     8,     3,     3,    13,    18,    11,    18,
      18,     3,     3,     3,    16,     4,     4,     3,    12,    12,
       3,     3,     3,    -1,    -1,     3,    13,     3,    13,    -1,
      14,     3,    -1,    -1,    -1,    -1,    16,    16,    -1,    14,
      14,    14
};
...
{
       0,     5,    22,    23,    24,     6,     7,     8,     0,     3,
       9,    10,    20,    24,    25,    26,    27,     3,     3,     3,
      13,    11,    11,    27,    26,    15,    17,    19,    18,    18,
      18,     3,     3,     3,    27,    27,     4,     4,     3,    16,
      12,    12,     3,    13,    13,    14,     3,     3,    16,    16,
       3,     3,    14,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: declarations statement_list  */
#line 28 "parser.y"
    {
...
#line 35 "parser.y"
    {
        fprintf(stderr, "Parsed a declaration: %s\n", (yyvsp[0].str));
    }
...
#line 1137 "parser.tab.c"
  ...
  case 5: /* declaration: DECLARE PREDICATE STRING COLON NUMBER  */
#line 46 "parser.y"
    {
        fprintf(stderr, "Parsed a predicate declaration: %s\n", (yyvsp[-2].str));
    }
#line 1145 "parser.tab.c"
    break;

  case 6: /* declaration: DECLARE FUNCTION STRING COLON NUMBER  */
#line 50 "parser.y"
    {
        fprintf(stderr, "Parsed a function declaration: %s\n", (yyvsp[-2].str));
    }
...
#line 54 "parser.y"
    {
        fprintf(stderr, "Parsed a variable declaration: %s\n", (yyvsp[-2].str));
    }
...
#line 1185 "parser.tab.c"
  ...
  case 11: /* expression: EXIST LBRACK STRING RBRACK LPAREN STRING COMMA STRING RPAREN  */
#line 79 "parser.y"
    {
...
#line 1193 "parser.tab.c"
  ...
  case 12: /* expression: ALL LBRACK STRING RBRACK LPAREN STRING COMMA STRING RPAREN  */
#line 83 "parser.y"
    {
...
#line 1217 "parser.tab.c"
  ...
  case 15: /* expression: NEGATION expression  */
#line 95 "parser.y"
    {
...
#line 1225 "parser.tab.c"
  ...
  case 16: /* expression: STRING LPAREN STRING COMMA STRING RPAREN  */
#line 99 "parser.y"
    {
        fprintf(stderr, "Parsed a function call with argument: %s\n", (yyvsp[-5].str));
    }
...
#line 103 "parser.y"
    {
        fprintf(stderr, "Parsed a string: %s\n", (yyvsp[0].str));
    }
